...
class Abenteuer extends React.Component {
 ...
 this.setState({dialogOpen: false})
  ...
  render() {
    ...
    return (
      ...
      <CollapsibleAppBar open={this.state.open} handleDrawerOpen={this.handleDrawerOpen} pageTitle={"Fable.Quests"} handleDialogOpen={this.handleDialogOpen} />
}
...
export default withStyles(styles, { withTheme: true })(Abenteuer);
