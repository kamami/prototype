  ...
  this.state = {
    ...
    render() {
      const { classes } = this.props;
        ...
        <div style={{width: '60vw', marginLeft: 'auto', marginRight: 'auto'}}>
            ...
            <div style={{marginTop: -20}}>
              ...
              <div  style={{marginTop: 'auto', marginBottom: 'auto'}}>
                <Link to="/home" style={{textDecoration: 'none'}}>
                    ...
                    <Typography style={{fontFamily: 'Pacifico', fontSize: '3em', useNextVariants: true, marginLeft: '4vw', marginTop: '4vw'}} className="logoColor">
                        Fable.
                      </Typography>
                    </Link>
            ...
            <div style={{padding: '4vw'}}>
              <p style={{color: '#FF6B6B', textAlign: 'center', fontSize: '3em', fontFamily: 'Roboto', fontWeight: 'bold', lineHeight: 1.3}}> Jeden Tag ein Abenteuer.</p>
                <p style={{color: '#484F58', textAlign: 'center', fontSize: '1.3em', fontFamily: 'Roboto', lineHeight: 1.3}}> Fable hebt Chatbots auf die Ebene des Entertainments.
            ...
            <div style={{width: '100%', backgroundColor: '#ffffff'}}>
              ...
              <div style={{padding: '4vw'}}>
                ...
                <Button  variant="contained"
                  style={{height: 40, width: '40%', boxShadow: 'none', marginLeft: 'auto', marginRight: 'auto', background: '#0084ff', color: '#ffffff',  marginBottom: '3vh'}}>
